<main>
    ...
    <section id="total">
		...
		<p>Total de productos: 
       		<b><?= DBPDO::total('products') ?></b>
		</p>
		<p>Fecha de alta del último usuario: 
			<b><?= DBPDO::total('users','MAX','created_at') ?></b>
		</p>
		<p>Menor precio de un producto:
			<b><?= DBPDO::total('products','MIN','price') ?>€</b>
		</p>
        <p>Precio medio de los productos: 
        	<b><?= DBPDO::total('products','AVG','price') ?>€</b>
    	</p>
    </section>    
     ...
     <section id="totalGroups">
    	...
    	<table class="table centered w50">
            ...
            <?php 
                ...
                $resultados = DBPDO::selectAll($consulta);
