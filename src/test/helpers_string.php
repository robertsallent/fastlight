<main>
    ...
    <section id="humanDate">
        <h2>humanDate()</h2>
        <p>Convierte un texto con la fecha en formato aaaa-mm-dd hh:mm:ss a
        un formato legible por los humanos en castellano.</p>
        
        <p>Por ejemplo, el texto 2025-02-01 10:00:25 se convierte en:</p>
        
        <div class="p1 border">
        <?php 
            $texto = "2025-02-01 10:00:25";
            echo humanDate($texto);
        ?>
        </div>
    </section>
</main>